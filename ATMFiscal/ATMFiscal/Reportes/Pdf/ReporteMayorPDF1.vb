...
Public Class ReporteMayorPDF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ATMFiscal.ReporteMayorPDF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteMayorPDF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteMayorPDF = New ReporteMayorPDF()
        rpt.Site = Me.Site
        Return rpt
    End Function
