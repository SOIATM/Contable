...
Public Class ReportePolizaPDF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ATMFiscal.ReportePolizaPDF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportePolizaPDF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportePolizaPDF = New ReportePolizaPDF()
        rpt.Site = Me.Site
        Return rpt
    End Function
